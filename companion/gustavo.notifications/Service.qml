...
Item {
  ...
  function handleNotification(notification) {
    ...
    Quickshell.execDetached(["omarchy-shell", "gustavo.bar", "showNotification", JSON.stringify(snapshot)])
  ...
  IpcHandler {
    ...
    function showHistory(): string {
      Quickshell.execDetached(["omarchy-shell", "gustavo.bar", "openHistory"])
      return "ok"
    }
